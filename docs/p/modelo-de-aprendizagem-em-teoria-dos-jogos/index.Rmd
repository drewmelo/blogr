...
```{r game14, echo = TRUE, fig.keep='none', results='hide'}
...
```{r game14c, echo = TRUE, comment="", results='hide'}
...
<div class="output-learningexemplop1">
<pre>
  <span>   
...
<div class="output-learningexemplop2">
<pre>
  <span>   
...
```{r game14d, echo = TRUE, comment="", results='hide'}
...
<div class="output-learningatracaop1">
<pre>
  <span>   
jogo12$attraction$A1[[10]]
   Manter Preço Reduzir Preço period
...
<div class="output-learningatracaop2">
<pre>
  <span>   
jogo12$attraction$A2[[10]]
   Manter Preço Reduzir Preço period
...
```{r game15, results = 'hide', fig.align='center'}
...
```{r game16, results = 'hide', fig.align='center'}
...
```{r game18, results = 'hide', fig.align='center'}
