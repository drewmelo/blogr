...
.callout-content {
  ...
  border-top: 1px solid #ccc; /* Adicione uma linha superior */
  margin-bottom: -50px;
}

.callout-container {
  background: linear-gradient(95deg, #9198e5, #e66465);
  color: white;
  padding: 10px;
  display: flex;
  align-items: center;
...
<div class="callout-container">
  <div>
    `r icons::icon_style(fontawesome("bomb", style = "solid"), scale = 1.2, fill = "#003153")`
  </div>
